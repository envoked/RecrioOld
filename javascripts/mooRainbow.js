...
var MooRainbow = new Class({
	...
	manualSet: function(color, type) {
		...
		else { hex = color; rgb = color.hexToRgb(); hsb = color.hexToRgb(true).rgbToHsb(); }
	...
	setMooRainbow: function(color, type) {
		...
		if (type == 'rgb') { rgb = color; hsb = color.rgbToHex().hexToRgb(true).rgbToHsb(); hex = color.rgbToHex(); } 
		else if (type == 'hsb') { hsb = color; rgb = color.hsbToRgb(); hex = rgb.rgbToHex(); }
		else { hex = color;
			   rgb = color.hexToRgb();
			   hsb = color.hexToRgb(true).rgbToHsb(); }
